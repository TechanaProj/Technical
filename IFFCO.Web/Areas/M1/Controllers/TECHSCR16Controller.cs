...
namespace IFFCO.TECHPROD.Web.Areas.M1.Controllers
{
    ...
    public class TECHSCR16Controller : BaseController<TECHSCR16ViewModel>
    {
        ...
        public ActionResult GenerateReport(DateTime FromDate, DateTime ToDate, string ReportType, string InputType)
        {
            ...
            Report reportobj = GenerateReportData(FromDate,ToDate,ReportType,InputType,separator);
        ...
        public Report GenerateReportData(DateTime FromDate, DateTime ToDate, string ReportType, string InputType,string seprator)
        {
