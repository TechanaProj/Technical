...
{
    [Area("M1")]
    public class TECHSCR03Controller : BaseController<TECHSCR03ViewModel>
    {
        ...
        public TECHSCR03Controller(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(DateTime ReportDate, string seprator)
        {
            ...
            ReportData.ReportName = "telexrepN."+extension;
            return ReportData;
        }
