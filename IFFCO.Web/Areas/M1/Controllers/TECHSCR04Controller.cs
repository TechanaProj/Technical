...
{
    [Area("M1")]
    public class TECHSCR04Controller : BaseController<TECHSCR04ViewModel>
    {
        ...
        public TECHSCR04Controller(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(DateTime ReportDate,string seprator)
        {
            ...
            ReportData.ReportName = "spengN."+extension;
            return ReportData;
        }
