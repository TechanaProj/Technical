...
namespace IFFCO.TECHPROD.Web.Areas.M1.Controllers
{
    ...
    public class TECHSCR17AController : BaseController<TECHSCR17AViewModel>
    {
        ...
        public ActionResult GenerateReport(DateTime FromDate, DateTime ToDate, string Report1, string Gas, string ForReport)
        {
            ...
            Report reportobj = GenerateReportData(FromDate, ToDate, Report1, Gas, ForReport, separator);
        ...
        public Report GenerateReportData(DateTime FromDate, DateTime ToDate, string Report1, string Gas, string ForReport, string seprator)
        {
            bool rdlc = false;
            string extension = "rep";
            if (HttpContext.Session.GetString("ReportServer").ToLower().Contains("tech"))
            ...
            ReportData.Query = "I_DT1=" + FromDate.Date() + seprator + "I_DT2=" + ToDate.Date() + seprator + "TPE=" + ForReport + seprator + "GAS=" + Gas;
            //ReportData.ReportName = "F1report.rep";
            switch (Report1)
            {
                case "N":

                    ReportData.ReportName = "Norms124." + extension;
                    break;
                case "NP":
