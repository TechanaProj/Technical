...
{
    [Area("M1")]
    public class TOP9CPPController : BaseController<TOP9CPPViewModel>
    {
        ...
        CommonException<TOP9CPPViewModel> commonException = null;

        public TOP9CPPController(ModelContext context)
        {
            _context = context;
            commonException = new CommonException<TOP9CPPViewModel>();
        ...
        public IActionResult Execute(string OperationType, string Plant, DateTime FromDate)
        {
            ...
            return PartialView("_partialTOP9CPP");
        }
        public IActionResult PostData(string OperationType, string Plant, DateTime FromDate, string Input_Name, string Input_Value, string InputType)
        {
            try
            {
                ...
                CommonViewModel.alert = TechnicalCommonService.PostRecordsTOP9CPP(FromDate, Plant, Input_Name, Input_Value, EMP_ID.ToString());
