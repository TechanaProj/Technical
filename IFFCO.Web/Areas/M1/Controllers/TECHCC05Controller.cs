...
{
    [Area("M1")]
    public class TECHCC05Controller : BaseController<TECHCC04ViewModel>
    {
        ...
        public TECHCC05Controller(ModelContext context)
        {
            _context = context;
        ...
        public IActionResult Execute(DateTime FromDate, DateTime ToDate)
        {
            ...
            try
            {
                int a = _context.ExecuteProcedure("gas_bifur", oracleParameterCollecion);
                if (a == -1)
                {
                    Alert alert = new Alert
                    {
