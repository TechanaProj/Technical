...
{
    [Area("M1")]
    public class TECHSCR29Controller : BaseController<TECHSCR03ViewModel>
    {
        ...
        public TECHSCR29Controller(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(DateTime ReportDate,string seprator)
        {
            ...
            ReportData.Query = "P_DT=" + ReportDate.Date();
            ReportData.ReportName = "phreport."+extension;
            return ReportData;
        }
