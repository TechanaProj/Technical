...
{
    [Area("M1")]
    public class TOP9AMMController : BaseController<TOP9AMMViewModel>
    {
        ...
        CommonException<TOP9AMMViewModel> commonException = null;

        public TOP9AMMController(ModelContext context)
        {
            _context = context;
            commonException = new CommonException<TOP9AMMViewModel>();
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                List<CommonData> data = TechnicalCommonService.GetRecordsTOP9AMM(DateTime.Now.AddDays(-1), "AM1");
        ...
        public IActionResult Execute(string OperationType, string Plant, DateTime FromDate)
        {
            ...
            try
            {
                ...
                {
                    case "query":
                        List<CommonData> data = TechnicalCommonService.GetRecordsTOP9AMM(FromDate, Plant);
                        ViewBag.reason = TechnicalCommonService.GetReason();
                        ViewBag.records = data;
            ...
            return PartialView("_partialTOP9AMM");
        }
        public IActionResult PostData(string OperationType, string Plant, DateTime FromDate, string Input_Name, string Input_Value, string InputType)
        {
            try
            {
                ...
                CommonViewModel.alert = TechnicalCommonService.PostRecordsTOP9AMM(FromDate, Plant, Input_Name,Input_Value, EMP_ID.ToString());
