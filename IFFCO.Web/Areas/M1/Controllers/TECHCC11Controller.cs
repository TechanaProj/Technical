...
{
    [Area("M1")]
    public class TECHCC11Controller : BaseController<TECHCC11ViewModel>
    {
        ...
        CommonException<TECHCC11ViewModel> commonException = null;

        public TECHCC11Controller(ModelContext context)
        {
            _context = context;
            commonException = new CommonException<TECHCC11ViewModel>();
