...
{
    [Area("M1")]
    public class TOP9LABController : BaseController<TOP9LABViewModel>
    {
        ...
        CommonException<TOP9LABViewModel> commonException = null;

        public TOP9LABController(ModelContext context)
        {
            _context = context;
            commonException = new CommonException<TOP9LABViewModel>();
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                List<CommonData> data = TechnicalCommonService.GetRecordsTOP9LAB(DateTime.Now.AddDays(-1), "SG");
        ...
        public IActionResult Execute(string OperationType, string Plant, DateTime FromDate)
        {
            ...
            try
            {
                ...
                {
                    case "query":
                        List<CommonData> data = TechnicalCommonService.GetRecordsTOP9LAB(FromDate, Plant);
                        ViewBag.reason = TechnicalCommonService.GetReason();
                        ViewBag.records = data;
            ...
            return PartialView("_partialTOP9LAB");
        }
        public IActionResult PostData(string OperationType, string Plant, DateTime FromDate, string Input_Name, string Input_Value, string InputType)
        {
            try
            {
                ...
                CommonViewModel.alert = TechnicalCommonService.PostRecordsTOP9LAB(FromDate, Plant, Input_Name, Input_Value, EMP_ID.ToString());
