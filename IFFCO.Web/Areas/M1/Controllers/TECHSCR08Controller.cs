...
{
    [Area("M1")]
    public class TECHSCR08Controller : BaseController<TECHSCR08ViewModel>
    {
        ...
        public TECHSCR08Controller(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(DateTime ReportDate)
        {
            ...
            ReportData.ReportName = "CHECKREPORT.rep";
            return ReportData;
        }
    }
}
