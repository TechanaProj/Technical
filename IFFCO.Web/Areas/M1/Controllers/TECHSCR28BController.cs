...
{
    [Area("M1")]
    public class TECHSCR28BController : BaseController<TECHSCR28ViewModel>
    {
        ...
        public TECHSCR28BController(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(TECHSCR28ViewModel tECHSCR28ViewModel)
        {
            ...
            ReportData.ReportName = "HINDI1delh1N." + extension;
