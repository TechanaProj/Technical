...
{
    [Area("M1")]
    public class TECHSCR01BController : BaseController<TECHSCR01BViewModel>
    {
        ...
        CommonException<TECHSCR01BViewModel> commonException = null;

        public TECHSCR01BController(ModelContext context)
        {
            _context = context;
            commonException = new CommonException<TECHSCR01BViewModel>();
        ...
        public Report GenerateReportData(DateTime ReportDate,string seprator)
        {
         ...
         ;
            ...
            ReportData.ReportName = "Combinetelexreport."+extension;
            return ReportData;
        }
