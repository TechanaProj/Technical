...
{
    [Area("M1")]
    public class TECHSCR05Controller : BaseController<TECHSCR05ViewModel>
    {
        ...
        public TECHSCR05Controller(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(DateTime ReportDate,string seprator)
        {
            ...
            ReportData.Query = "P_I_dt=" + ReportDate.Date();
            ReportData.ReportName = "sbN."+extension;
            return ReportData;
        }
