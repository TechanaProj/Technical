...
{
    [Area("M1")]
    public class TECHSCR17DController : BaseController<TECHSCR17DViewModel>
    {
        ...
        public TECHSCR17DController(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(DateTime FromDate, DateTime ToDate, string ReportType, string seprator)
        {
            ...
            ReportData.ReportName = "Norms_CHK_FF."+extension;
            return ReportData;
        }
