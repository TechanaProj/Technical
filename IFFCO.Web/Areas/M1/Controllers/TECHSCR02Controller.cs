...
{
    [Area("M1")]
    public class TECHSCR02Controller : BaseController<TECHSCR03ViewModel>
    {
        ...
        public TECHSCR02Controller(ModelContext context)
        {
            _context = context;
        ...
        public Report GenerateReportData(DateTime ReportDate,string seprator)
        {
            ...
            ReportData.ReportName = "dailyN."+ extension;
            return ReportData;
        }
